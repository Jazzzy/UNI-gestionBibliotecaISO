...
public class DAOPrestamoImpl implements DAOPrestamo {
    ...
    public VOPrestamo getPrestamoById(Integer id) {
        try {
            ...
            if (res.next()) {
                ...
                VOFondo fondo;
                if (res2.next()) {
                    usuario = new VOUsuario(id, res2.getString("nombre"), res2.getString("dni"),
                            res2.getBoolean("sexo"), res2.getDate("fecha_nacimiento"), res2.getString("direccion"),
                            res2.getString("telefono"), res2.getString("email"));
                ...
                if (res3.next()) {
                    fondo = new VOFondo(res3.getInt("id"), res3.getString("titulo"), res3.getDate("fecha_compra"));
                } else {
                    return null;
                }
    ...
    public ArrayList<VOPrestamo> getPrestamos() {
        try {
            ...
            while (res.next()) {
                ...
                if (res2.next()) {
                    usuario = new VOUsuario(res2.getInt("id"), res2.getString("nombre"), res2.getString("dni"),
                            res2.getBoolean("sexo"), res2.getDate("fecha_nacimiento"), res2.getString("direccion"),
                            res2.getString("telefono"), res2.getString("email"));
    ...
    public Integer anadirPrestamo(VOPrestamo prestamo) {
        ...
        try {
            ...
            String sqlCheck = "SELECT * FROM Prestamo WHERE id_fondo = ? AND fecha_fin = NULL;";
            
            pstmt3 = con.prepareStatement(sqlCheck);
            pstmt3.setInt(1, prestamo.getFondo().getId());
            
            ResultSet r = pstmt3.executeQuery();
            
            if(r.next()){
                System.out.println("Fondo en prestamo activo");
                return -1;
            }
